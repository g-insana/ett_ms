...
for OSCODE in $*; do
	...
	echo "${ETT_BIN}/track_missing_prots2.py --miss_fract=0.67 -P $map_file $DATA_DIR/${OSCODE}/Protein_clusters_m50pct.tsv > ${OSCODE}_miss_prots.miss_tfx_ex_r3"

	${ETT_BIN}/track_missing_prots2.py --miss_fract=0.67 -P $map_file $DATA_DIR/${OSCODE}/Protein_clusters_m50pct.tsv > ${OSCODE}_miss_prots.miss_tfx_ex_r3
